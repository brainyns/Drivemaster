  ...
  return (
    <div className="cp-root">
      ...
      <div className="cp-header">
        ...
        <button className="cp-btn-new" onClick={onVolver} style={{ background:"var(--surface2)",border:"1px solid var(--border2)",color:"var(--text)" }}>
          + Nueva Compra
        </button>
      </div>
      ...
      <div className="cp-detalle-layout">
        ...
        <div className="cp-detalle-main">
          ...
          <div className="cp-invoice-totals">
            ...
            <button className="cp-btn-outline" style={{ marginTop:"1rem",width:"100%",justifyContent:"center" }}>
              {IcDown} Download Transaction Log
            </button>
          </div>
        </div>
        ...
        <div className="cp-detalle-side">
          ...
          <div className="cp-side-panel">
            ...
            {[
              { ico: IcPrint, label:"Print Invoice" },
              { ico: IcDown,  label:"Download PDF" },
              { ico: IcTruck, label:"Email Supplier" },
            ].map((a,i) => (
              <button key={i} className="cp-action-row">
